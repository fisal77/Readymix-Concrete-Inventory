...
public class ReadymixProvider extends ContentProvider {
    ...
    private Uri insertReadymix(Uri uri, ContentValues values) {
        ...
        // Notify all listeners that the data has changed for the readymix product content URI
    ...
    private int updateReadymix(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int rowsUpdated = database.update(ReadymixEntry.TABLE_NAME, values, selection, selectionArgs);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case READYMIX:
                ...
                rowsDeleted = database.delete(ReadymixEntry.TABLE_NAME, selection, selectionArgs);
                break;
            case READYMIX_ID:
